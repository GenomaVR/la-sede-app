export const seed = {
usuarios: [
{ id: 1, nombre: 'Admin', apellido: 'Club', dni: '11111111', email: 'admin@aj.com', password: 'admin', rol: 'admin', activo: true, cuota: { mes: 11, anio: 2025, estado: 'paga', medio: 'efectivo' } },
{ id: 2, nombre: 'Lucas', apellido: 'Socio', dni: '22222222', email: 'socio@aj.com', password: 'socio', rol: 'user', activo: true, cuota: { mes: 10, anio: 2025, estado: 'pendiente', medio: null } },
],
canchas: [
